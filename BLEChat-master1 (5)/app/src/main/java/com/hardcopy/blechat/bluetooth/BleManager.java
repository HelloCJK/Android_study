...
public class BleManager {
    ...
    public static BleManager mBleManager = null;		// Singleton pattern
    ...
    public BluetoothDevice mDefaultDevice = null;

    public BluetoothGatt mBluetoothGatt = null;

    public ArrayList<BluetoothGattService> mGattServices
			= new ArrayList<BluetoothGattService>();
    public BluetoothGattService mDefaultService = null;
    public ArrayList<BluetoothGattCharacteristic> mGattCharacteristics
			= new ArrayList<BluetoothGattCharacteristic>();
    public ArrayList<BluetoothGattCharacteristic> mWritableCharacteristics
			= new ArrayList<BluetoothGattCharacteristic>();
    public BluetoothGattCharacteristic mDefaultChar = null;
...
//		mContext.unregisterReceiver(mReceiver);
	...
	public boolean write(BluetoothGattCharacteristic chr, byte[] data) {
        ...
        setCharacteristicNotification(mGattCharacteristics.get(6),true);
